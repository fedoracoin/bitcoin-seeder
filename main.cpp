...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "FedoraCoin-seeder\n"
...
static const string mainnet_seeds[] = {"seed.fedoracoin.net", ""};
static const string testnet_seeds[] = {"testnet-seed.fedoracoin.net", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("207.182.133.26", 44889), true);
    db.Add(CService("207.12.89.21", 44889), true);
    db.Add(CService("127.0.0.1", 44889), true);
  }
  do {
